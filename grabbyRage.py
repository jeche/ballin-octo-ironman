...
def main():
	...
	try:
	 	print("WhatWhat")
	 	connection = psycopg2.connect(database="OnlyMovies",
	...
	try:
		...
		curr.execute("SELECT TITLE, MEDIA_ID FROM MEDIA, TV WHERE MEDIA_ID = ID AND RAGE_ID IS NULL;")
